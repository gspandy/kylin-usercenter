...
//        redisTemplate.boundHashOps(redisUserLoginKey).expire(maxExpires, TimeUnit.SECONDS);
     ...
     * @throws Exception 
     */
    public static void setUserNameAndUserToken(String loginName,String orgCode,String userToken,int expireTime) throws Exception{
     ...
     * @throws Exception
     */
    public static void delUserTokenByNameAndTerminal(String loginName,String orgCode,TerminalType terminalType) throws Exception{
