...
public class CaasAgentFacade {
    ...
    public BaseResultVo<RegiesterResponse> regiest(String loginName,String password,String vcode,String xAuthToken) {
        ...
        RegisterResult register = this.stateableCaasAgent.register(loginName, null, null, password, vcode, appKey, xAuthToken);
    ...
    //更新密码
    public BaseResultVo<String> updatePwd(String accessToken, String oldPassword, String password,String vcode,String xAuthToke) {
        BaseResultVo<String> resultVo = new BaseResultVo<String>();
        try{
        ChangePasswordResult changePassword = this.stateableCaasAgent.changePassword(accessToken, oldPassword, password, vcode, xAuthToke);
   ...
   //获取用户信息
    ...
    //校验权限
    public BaseResultVo<Boolean> checkAuth(String accessToken, String resourceCode, String appCode,String operationCode) {
    ...
    public BaseResultVo<Boolean> batchCheckAuth(String accessToken, List<String> resourceCode, String appCode) {
        ...
        try {
            ...
            UserAuthStatus checkAuth = caasAgent.batchCheckAuth(accessToken, resourceCodes);
            if (checkAuth.isSuccess()) {
                resultVo.setSuccess(true);
