    ...
    public  void regist() throws RegiesterException{
      ...
      //  mt.setUserId("exsit001");
       // mt.setIdNumber("510105199010017995");
        mt.setUserName("153855101992");
        
        
        mt.setOrgCode("M000029");
...
//        BaseResultVo<Boolean> regist = userCenterService.regiest(po);
    ...
    public void login(){
        ...
        logininfo.setLoginName("153855101992");
...
//      request.setMobiletel(user.getUserName());
      ...
      openAccountPerson.setRootInstCd("M000029");
      openAccountPerson.setProductId("P00026");
      openAccountPerson.setUserId("UCP5145123123133");
      openAccountPerson.setAccountCode("UCM123123123");
      openAccountPerson.setCertificateType("0");
      openAccountPerson.setCertificateNumber("620721198309177755");
      openAccountPerson.setMobileTel("15215458787");
      
      BaseResultVo<Boolean> result = userCenterService.openAccountPerson(openAccountPerson);
